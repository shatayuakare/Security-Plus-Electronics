      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" id="spe-about-story-grid">
          <div className="space-y-6">
            <span className="font-sans font-bold text-[10px] text-primary tracking-widest uppercase block font-semibold">[ BRAND STORY // SINCE 2005 ]</span>
          ...
          {/* SVG drawing graphic of the CCTV store map / visual */}
          <div className="bg-white p-8 border border-slate-200 space-y-4 rounded-2xl shadow-sm relative">
            ...
            <div className="p-6 bg-slate-50 border border-slate-100 text-center space-y-3 rounded-xl">
              <ShieldCheck className="h-10 w-10 text-primary mx-auto animate-pulse" />
