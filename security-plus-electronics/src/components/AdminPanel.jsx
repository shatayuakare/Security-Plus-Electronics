...
export default function AdminPanel({ onExit, supportTickets, setSupportTickets, careerApplications, setCareerApplications, subscribers, setSubscribers, setToastMessage, products, setProducts, productCategories, setProductCategories, contactData, setContactData, logoData, setLogoData, socialLinks, setSocialLinks, reels, setReels, adminEmails, setAdminEmails, adminPasscodeVal, setAdminPasscodeVal }) {
    ...
    return (<div className="bg-[#0b0c10] text-slate-100 min-h-screen font-sans flex flex-col md:flex-row relative selection:bg-sky-500 selection:text-white">
      ...
      <div className="w-full md:w-64 bg-[#12141c] border-b md:border-b-0 md:border-r border-slate-800 p-6 flex flex-col justify-between shrink-0 relative z-10">
        <div>
          ...
          <nav className="space-y-1">
            ...
            <button onClick={() => { setActiveTab("tickets"); addLog("NAV", "Opened SLA Tickets Ledger."); }} className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-mono text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer ${activeTab === "tickets" ? "bg-sky-600/15 text-sky-400 border border-sky-500/30 shadow-md shadow-sky-950/20" : "text-slate-400 hover:text-white hover:bg-slate-800/40 border border-transparent"}`}>
              <span className="flex items-center gap-2.5">
            ...
            <button onClick={() => { setActiveTab("admin_manager"); addLog("NAV", "Opened Admin Accounts Manager."); }} className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-mono text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer ${activeTab === "admin_manager" ? "bg-sky-600/15 text-sky-400 border border-sky-500/30 shadow-md shadow-sky-950/20" : "text-slate-400 hover:text-white hover:bg-slate-800/40 border border-transparent"}`}>
              <span className="flex items-center gap-2.5">
            ...
            <button onClick={() => { setActiveTab("careers"); addLog("NAV", "Opened Career Application Board."); }} className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-mono text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer ${activeTab === "careers" ? "bg-sky-600/15 text-sky-400 border border-sky-500/30 shadow-md shadow-sky-950/20" : "text-slate-400 hover:text-white hover:bg-slate-800/40 border border-transparent"}`}>
              <span className="flex items-center gap-2.5">
            ...
            <button onClick={() => { setActiveTab("subscribers"); addLog("NAV", "Opened Subscriber Email Lists."); }} className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-mono text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer ${activeTab === "subscribers" ? "bg-sky-600/15 text-sky-400 border border-sky-500/30 shadow-md shadow-sky-950/20" : "text-slate-400 hover:text-white hover:bg-slate-800/40 border border-transparent"}`}>
              <span className="flex items-center gap-2.5">
            ...
            <button onClick={() => { setActiveTab("products"); addLog("NAV", "Opened Catalog Products Manager."); }} className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-mono text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer ${activeTab === "products" ? "bg-sky-600/15 text-sky-400 border border-sky-500/30 shadow-md shadow-sky-950/20" : "text-slate-400 hover:text-white hover:bg-slate-800/40 border border-transparent"}`}>
              <span className="flex items-center gap-2.5">
            ...
            <button onClick={() => { setActiveTab("categories"); addLog("NAV", "Opened Categories Manager."); }} className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-mono text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer ${activeTab === "categories" ? "bg-sky-600/15 text-sky-400 border border-sky-500/30 shadow-md shadow-sky-950/20" : "text-slate-400 hover:text-white hover:bg-slate-800/40 border border-transparent"}`}>
              <span className="flex items-center gap-2.5">
            ...
            <button onClick={() => { setActiveTab("branding"); addLog("NAV", "Opened Branding & Contacts Configuration."); }} className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-mono text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer ${activeTab === "branding" ? "bg-sky-600/15 text-sky-400 border border-sky-500/30 shadow-md shadow-sky-950/20" : "text-slate-400 hover:text-white hover:bg-slate-800/40 border border-transparent"}`}>
              <span className="flex items-center gap-2.5">
            ...
            <button onClick={() => { setActiveTab("reels"); addLog("NAV", "Opened Action Reels Manager."); }} className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-mono text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer ${activeTab === "reels" ? "bg-sky-600/15 text-sky-400 border border-sky-500/30 shadow-md shadow-sky-950/20" : "text-slate-400 hover:text-white hover:bg-slate-800/40 border border-transparent"}`}>
              <span className="flex items-center gap-2.5">
            ...
            <button onClick={() => { setActiveTab("config"); addLog("NAV", "Opened API Expansion Module Console."); }} className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-mono text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer ${activeTab === "config" ? "bg-sky-600/15 text-sky-400 border border-sky-500/30 shadow-md shadow-sky-950/20" : "text-slate-400 hover:text-white hover:bg-slate-800/40 border border-transparent"}`}>
              <span className="flex items-center gap-2.5">
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8">
                  ...
                  <div className="space-y-4 my-6">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="h-1.5 w-full bg-[#1b1e2a] rounded-full overflow-hidden">
                        <div className="h-full bg-sky-500 transition-all duration-1000" style={{ width: `${cpuLoad}%` }}></div>
                      </div>
                    </div>
          ...
          {activeTab === "tickets" && (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4 bg-[#12141c] p-4 border border-slate-800 rounded-2xl">
                <div className="relative flex-1">
                  ...
                  <input type="text" placeholder="Search tickets by SLA key, candidate name, or core message..." value={ticketSearch} onChange={(e) => setTicketSearch(e.target.value)} className="w-full bg-[#0b0c10] border border-slate-800 pl-10 pr-4 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-550 focus:border-sky-500 placeholder-slate-500"/>
                </div>

                <div className="flex gap-2">
                  {["all", "open", "assigned", "resolved"].map((filter) => (<button key={filter} onClick={() => setTicketFilter(filter)} className={`px-3 py-1.5 rounded-lg font-mono text-[9px] font-bold uppercase tracking-widest border transition-all cursor-pointer ${ticketFilter === filter ? "bg-sky-600/15 text-sky-400 border-sky-500/30" : "bg-[#0b0c10] text-slate-400 border-slate-800 hover:text-white"}`}>
                      {filter}
                    </button>))}
                </div>
              </div>
          ...
          {activeTab === "admin_manager" && (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 font-sans">
                ...
                form.reset();
                    ...
                    <input name="newAdminEmail" type="email" required placeholder="Enter new administrator email address..." className="flex-1 bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-500 placeholder-slate-500 font-mono"/>
                    <button type="submit" className="px-4 py-2 bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs uppercase rounded-xl transition-all cursor-pointer flex items-center gap-1.5 shrink-0">
          ...
          {activeTab === "careers" && (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
              ...
              <div className="flex justify-between items-center bg-[#12141c] p-4 border border-slate-800 rounded-2xl">
                <div className="relative flex-1 max-w-md">
                  <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500"/>
                  <input type="text" placeholder="Search candidate index..." value={careerSearch} onChange={(e) => setCareerSearch(e.target.value)} className="w-full bg-[#0b0c10] border border-slate-800 pl-10 pr-4 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-550 focus:border-sky-500 placeholder-slate-500"/>
                </div>
          ...
          {activeTab === "config" && (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8 max-w-4xl mx-auto">
              ...
              <div className="bg-[#12141c] p-6 rounded-3xl border border-slate-800 shadow-xl space-y-6">
                <div className="flex justify-between items-center border-b border-slate-800 pb-3">
                  ...
                  <button onClick={() => setShowAddModuleModal(true)} className="px-3 py-1.5 bg-sky-600 hover:bg-sky-700 text-white font-mono text-[9px] font-bold tracking-widest uppercase border border-sky-600 rounded-lg transition-all flex items-center gap-1 cursor-pointer">
                    <Plus className="h-3.5 w-3.5"/>
          ...
          {activeTab === "products" && (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-[#12141c] p-6 rounded-3xl border border-slate-800">
                ...
                <button onClick={handleOpenAddProduct} className="px-4 py-2.5 bg-sky-600 hover:bg-sky-700 text-white font-mono text-[10px] font-bold tracking-widest uppercase rounded-xl transition-all flex items-center gap-2 cursor-pointer shadow-md shadow-sky-950/40">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                <div className="md:col-span-8 relative">
                  <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500"/>
                  <input type="text" placeholder="Search product title, descriptions, or specs..." value={productSearch} onChange={(e) => setProductSearch(e.target.value)} className="w-full bg-[#12141c] border border-slate-800 rounded-xl pl-10 pr-4 py-3 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-500 font-sans"/>
                </div>
                <div className="md:col-span-4">
                  <select value={productCategoryFilter} onChange={(e) => setProductCategoryFilter(e.target.value)} className="w-full bg-[#12141c] border border-slate-800 rounded-xl px-4 py-3 text-xs text-slate-300 focus:outline-none focus:border-sky-500 font-sans font-bold cursor-pointer">
              ...
              <div className="bg-[#12141c] p-6 rounded-3xl border border-slate-800 shadow-xl">
                <form onSubmit={handleAddCategory} className="flex gap-3">
                  <div className="flex-1">
                    <input type="text" placeholder="e.g., Thermal Imaging, Fiber Hardware, Access Terminals..." value={categoryInput} onChange={(e) => setCategoryInput(e.target.value)} required className="w-full bg-[#0b0c10] border border-slate-800 px-4 py-3 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                  </div>
                  <button type="submit" className="px-5 py-3 bg-sky-600 hover:bg-sky-700 text-white font-mono text-[10px] font-bold tracking-widest uppercase border border-sky-600 rounded-xl transition-all cursor-pointer flex items-center gap-1.5">
                    <Plus className="h-3.5 w-3.5"/>
                    CREATE CATEGORY
                  </button>
                </form>
                ...
                <div className="space-y-3">
                  {productCategories.map((cat, idx) => (<div key={idx} className="bg-[#0b0c10] p-4 rounded-xl border border-slate-800 flex justify-between items-center gap-4">
                      {editingCategoryIndex === idx ? (<div className="flex-1 flex gap-2">
                          <input type="text" value={editingCategoryValue} onChange={(e) => setEditingCategoryValue(e.target.value)} className="bg-slate-900 border border-slate-700 px-3 py-1.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-lg font-sans flex-1"/>
                ...
                <form onSubmit={handleSaveBranding} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input type="text" value={companyName} onChange={(e) => setCompanyName(e.target.value)} required className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest font-sans">[ SUB-BRAND / SUFFIX ]</label>
                      <input type="text" value={companySuffix} onChange={(e) => setCompanySuffix(e.target.value)} required className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                    </div>
                  </div>

                  <div className="space-y-1.5">
                    <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest font-sans">[ LOGO ASSET URL ]</label>
                    <input type="text" value={logoUrl} onChange={(e) => setLogoUrl(e.target.value)} required className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                  </div>
                ...
                <form onSubmit={handleSaveContactAndSocials} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input type="text" value={contactPhone} onChange={(e) => setContactPhone(e.target.value)} required className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest font-sans">[ SYSTEM SUPPORT EMAIL ]</label>
                      <input type="email" value={contactEmail} onChange={(e) => setContactEmail(e.target.value)} required className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea rows={2} value={contactAddress} onChange={(e) => setContactAddress(e.target.value)} required className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input type="text" value={contactMapAddress} onChange={(e) => setContactMapAddress(e.target.value)} required className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans" placeholder="e.g. West High Court Road, Dharampeth, Nagpur"/>
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest font-sans">[ OPERATING HOURS DESCRIPTION ]</label>
                      <textarea rows={1} value={contactHours} onChange={(e) => setContactHours(e.target.value)} required className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-slate-800 pt-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-1.5">
                        ...
                        <input type="text" value={socialTwitter} onChange={(e) => setSocialTwitter(e.target.value)} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-[9px] font-bold text-slate-500 uppercase tracking-widest font-sans">Facebook URL</label>
                        <input type="text" value={socialFacebook} onChange={(e) => setSocialFacebook(e.target.value)} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-[9px] font-bold text-slate-500 uppercase tracking-widest font-sans">LinkedIn URL</label>
                        <input type="text" value={socialLinkedin} onChange={(e) => setSocialLinkedin(e.target.value)} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-sky-500 rounded-xl font-sans"/>
                      </div>
                    </div>
                  </div>
          ...
          {activeTab === "reels" && (<motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#12141c] p-6 border border-slate-800 rounded-2xl">
                ...
                <button onClick={handleOpenAddReel} className="px-4 py-2.5 bg-sky-600 hover:bg-sky-700 text-white font-mono text-[10px] font-bold tracking-widest uppercase rounded-xl transition-all cursor-pointer flex items-center gap-1.5 shrink-0 self-start sm:self-center">
                  <Plus className="h-4 w-4"/>
                  ADD NEW REEL
                </button>
              </div>
              ...
              <div className="p-6 space-y-6 overflow-y-auto max-h-[75vh]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <select value={selectedTicket.assignedTo || ""} onChange={(e) => handleAssignTicket(selectedTicket.id, e.target.value)} className="w-full bg-[#0b0c10] border border-slate-800 text-slate-200 text-xs px-3 py-2 rounded-xl focus:outline-none focus:border-sky-500">
                ...
                <div className="space-y-3 pt-4 border-t border-slate-800">
                  ...
                  <div className="flex gap-2">
                    <input type="text" placeholder="Add diagnostic audit logs to this ticket..." value={ticketNoteText} onChange={(e) => setTicketNoteText(e.target.value)} className="flex-1 bg-[#0b0c10] border border-slate-800 text-xs px-3.5 py-2 rounded-xl focus:outline-none focus:border-sky-500 text-white placeholder-slate-600"/>
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="bg-[#12141c] border border-slate-800 w-full max-w-md overflow-hidden rounded-2xl shadow-2xl flex flex-col">
              ...
              <form onSubmit={handleAddCustomModule} className="p-6 space-y-4">
                <div className="space-y-1">
                  ...
                  <input type="text" required placeholder="e.g. Firebase Live Attendance Sync" value={newModuleName} onChange={(e) => setNewModuleName(e.target.value)} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-500 placeholder-slate-650"/>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea rows={3} placeholder="Describe how your future API call, SQL query or webhook will operate in this section..." value={newModuleDesc} onChange={(e) => setNewModuleDesc(e.target.value)} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-500 placeholder-slate-650"/>
                </div>
                ...
                <div className="pt-4 border-t border-slate-800 flex gap-2">
                  ...
                  <button type="submit" className="flex-1 py-2 bg-sky-600 hover:bg-sky-700 text-white font-mono text-[9px] font-bold tracking-widest uppercase rounded-xl transition-all border border-sky-600 cursor-pointer text-center">
                    CONFIGURE NODE
                  </button>
                </div>
              </form>
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="bg-[#12141c] border border-slate-800 w-full max-w-2xl overflow-hidden rounded-2xl shadow-2xl flex flex-col">
              ...
              <form onSubmit={handleSaveProduct} className="p-6 space-y-4 overflow-y-auto max-h-[75vh]">
                <div className="space-y-1">
                  ...
                  <input type="text" required placeholder="e.g. Woston PTZ 4K Zoom Camera" value={productForm.name} onChange={(e) => setProductForm(prev => ({ ...prev, name: e.target.value }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-500"/>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-1">
                    <label className="text-[9px] font-mono font-bold text-slate-500 uppercase tracking-wider block">Hardware Category</label>
                    <select value={productForm.category} onChange={(e) => setProductForm(prev => ({ ...prev, category: e.target.value }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-500 font-sans cursor-pointer">
                  ...
                  <div className="space-y-1">
                    ...
                    <input type="text" required placeholder="e.g. ₹3,499" value={productForm.price} onChange={(e) => setProductForm(prev => ({ ...prev, price: e.target.value }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-500"/>
                  </div>

                  <div className="space-y-1">
                    <label className="text-[9px] font-mono font-bold text-slate-500 uppercase tracking-wider block">Rating Star (1.0 - 5.0)</label>
                    <input type="number" step="0.1" min="1.0" max="5.0" required value={productForm.rating} onChange={(e) => setProductForm(prev => ({ ...prev, rating: parseFloat(e.target.value) || 4.5 }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-500"/>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <select value={productForm.image} onChange={(e) => setProductForm(prev => ({ ...prev, image: e.target.value }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-500 font-sans cursor-pointer">
                ...
                <div className="space-y-1">
                  ...
                  <textarea rows={2} required placeholder="Enter professional hardware description..." value={productForm.desc} onChange={(e) => setProductForm(prev => ({ ...prev, desc: e.target.value }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3.5 py-2.5 text-xs text-white rounded-xl focus:outline-none focus:border-sky-500 font-sans"/>
                </div>
                ...
                <div className="space-y-3 pt-3 border-t border-slate-800">
                  ...
                  <div className="space-y-2 max-h-40 overflow-y-auto pr-1">
                    {productForm.specs.map((spec, index) => (<div key={index} className="flex gap-2 items-center">
                        <input type="text" placeholder="Label (e.g. Lens)" required value={spec.label} onChange={(e) => handleSpecChange(index, "label", e.target.value)} className="flex-1 bg-[#0b0c10] border border-slate-800 px-3 py-2 text-xs text-white rounded-lg focus:outline-none focus:border-sky-500"/>
                        <input type="text" placeholder="Value (e.g. 3.6mm)" required value={spec.value} onChange={(e) => handleSpecChange(index, "value", e.target.value)} className="flex-1 bg-[#0b0c10] border border-slate-800 px-3 py-2 text-xs text-white rounded-lg focus:outline-none focus:border-sky-500"/>
                ...
                <div className="pt-4 border-t border-slate-800 flex gap-2">
                  ...
                  <button type="submit" className="flex-1 py-2.5 bg-sky-600 hover:bg-sky-700 text-white font-mono text-[9px] font-bold tracking-widest uppercase rounded-xl transition-all border border-sky-600 cursor-pointer text-center">
                    SAVE CATALOG DATA
                  </button>
                </div>
              </form>
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="bg-[#12141c] border border-slate-800 w-full max-w-lg overflow-hidden rounded-2xl shadow-2xl flex flex-col">
              ...
              <form onSubmit={handleSaveReel} className="p-6 space-y-4">
                <div className="space-y-1">
                  ...
                  <input type="text" required placeholder="e.g. AI-Powered Starlight Night Vision" value={reelForm.title} onChange={(e) => setReelForm(prev => ({ ...prev, title: e.target.value }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3 py-2 text-xs text-white rounded-lg focus:outline-none focus:border-sky-500"/>
                </div>

                <div className="space-y-1">
                  <label className="text-[9px] font-mono font-bold text-slate-500 uppercase tracking-wider block">Video MP4 URL</label>
                  <input type="text" required placeholder="https://assets.mixkit.co/..." value={reelForm.videoUrl} onChange={(e) => setReelForm(prev => ({ ...prev, videoUrl: e.target.value }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3 py-2 text-xs text-white rounded-lg focus:outline-none focus:border-sky-500 font-mono"/>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <select value={reelForm.category} onChange={(e) => setReelForm(prev => ({ ...prev, category: e.target.value }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3 py-2 text-xs text-white rounded-lg focus:outline-none focus:border-sky-500">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input type="text" required value={reelForm.views} onChange={(e) => setReelForm(prev => ({ ...prev, views: e.target.value }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3 py-2 text-xs text-white rounded-lg focus:outline-none focus:border-sky-500"/>
                  </div>
                  <div className="space-y-1">
                    <label className="text-[9px] font-mono font-bold text-slate-500 uppercase tracking-wider block">Initial Likes Count</label>
                    <input type="number" required value={reelForm.likes} onChange={(e) => setReelForm(prev => ({ ...prev, likes: parseInt(e.target.value) || 0 }))} className="w-full bg-[#0b0c10] border border-slate-800 px-3 py-2 text-xs text-white rounded-lg focus:outline-none focus:border-sky-500"/>
                  </div>
                </div>
