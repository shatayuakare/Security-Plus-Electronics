...
const Hero = ({ heroSlideIndex, setHeroSlideIndex, setActiveTab, setBookingConfirmed, setBookingForm, setShowroomModalOpen, }) => {
  ...
  // return (
  //   <header className="relative min-h-[92vh] flex flex-col justify-between pt-28 pb-16 overflow-hidden border-b border-slate-900 bg-[#070913]">
  //     <div className="absolute inset-0 z-0 select-none overflow-hidden">
  //       {/* <video autoPlay loop muted playsInline className="w-full h-full object-cover opacity-[0.12] object-center scale-105 pointer-events-none" poster={cctvHeroBg}>
  //         <source src="https://assets.mixkit.co/videos/preview/mixkit-security-cameras-in-a-control-room-41712-large.mp4" type="video/mp4" />
  //       </video> */}
  ...
  //                 </div>
  //               </div>
  //               <div className="max-h-96 border min-w-90 rounded-3xl aspect-square overflow-hidden">
  //                 <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRhdtYeB2dsw60GGBh-mN8ZgceB3lpE8XdlEti74LUpQ&s=10" alt="" className="w-full h-full object-cover" />
  //               </div>
  ...
  //               </div>
  //             </div>
  //             <div className="min-h-96 border min-w-96 rounded-3xl overflow-hidden">
  //               <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRhdtYeB2dsw60GGBh-mN8ZgceB3lpE8XdlEti74LUpQ&s=10" alt="" className="w-full h-full object-cover" />
  //               {/* <img src={heroSlideIndex === 0 ? cctvHeroBg : heroSlideIndex === 1 ? cctvHeroBg : heroSlideIndex === 2 ? cctvHeroBg : heroSlideIndex === 3 ? cctvHeroBg : heroSlideIndex === 4 ? cctvHeroBg : ""} alt="" className="w-full h-full object-cover" /> */}
  //             </div>
  ...
  //             <div className="lg:col-span-5 flex justify-center items-center">
  //               <div className="relative w-full max-w-90 aspect-square rounded-3xl bg-slate-900/30 border border-slate-800 p-6 flex flex-col justify-center items-center overflow-hidden">
