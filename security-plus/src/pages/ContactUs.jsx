            ...
            <div className="bg-white p-6 border border-slate-200 rounded-2xl shadow-sm space-y-3.5 flex-1 flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <p className="text-xs text-slate-500 leading-relaxed font-sans">
                  Besides P.S. Home Appliances, Main Rd, opposite Naresh Hardware, Sahu Colony, Sitabuldi, Nagpur, Maharashtra 440012
                </p>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 max-w-6xl mx-auto overflow-hidden">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center pb-4 border-b border-slate-100 gap-4 mb-6">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1 font-sans">Besides P.S. Home Appliances, Main Rd, opposite Naresh Hardware, Sahu Colony, Sitabuldi, Nagpur, Maharashtra 440012</p>
            </div>
            <Link to="https://www.google.com/maps/place/SECURITY+PLUS+ELECTRONICS+(CCTV+MALL)/@21.1451489,79.0870572,17z/data=!3m1!4b1!4m6!3m5!1s0x3bd4c11c7803d3b5:0xa9e24cf23ec1d907!8m2!3d21.1451489!4d79.0870572!16s%2Fg%2F11z0yx02gs?entry=ttu&g_ep=EgoyMDI2MDcyOS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 bg-slate-900 hover:bg-slate-800 text-white text-xs px-4 py-2.5 rounded-xl font-sans font-bold uppercase transition-colors shrink-0">
          ...
          <div className="h-[380px] w-full rounded-xl overflow-hidden border border-slate-100 shadow-inner bg-slate-100">
            <iframe title="SPE CCTV Mall Nagpur Flagship Showroom Address Map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3721.182132469567!2d79.08705719999999!3d21.1451489!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd4c11c7803d3b5%3A0xa9e24cf23ec1d907!2sSECURITY%20PLUS%20ELECTRONICS%20(CCTV%20MALL)!5e0!3m2!1sen!2sin!4v1785588889698!5m2!1sen!2sin" className="w-full h-full border-0" allowFullScreen={false} loading="lazy" referrerPolicy="no-referrer" />
          </div>
        </div>
