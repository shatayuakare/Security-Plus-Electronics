    ...
    <div className={activeTab === "home" ? "pt-0 bg-[#070913]" : "pt-20 bg-white"}>
      ...
      {activeTab === "ecosystem" && (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
        ...
        {false && (<section className="py-24 px-8 relative z-20 border-b border-[#2A2A2A] bg-[#0A0E1A]/40">
          <div className="max-w-7xl mx-auto">
            <motion.div {...fadeInUp} className="text-center mb-16">
              <span className="font-headline font-bold text-[10px] text-[#FF5A00] tracking-widest uppercase block mb-3">[ 04 // SECTORBLUEPRINTS ]</span>
            ...
            <div className="bg-[#121212] p-8 border border-[#2A2A2A] max-w-5xl mx-auto rounded-none">
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                <div className="w-full lg:w-1/3">
                  ...
                  }} className="w-full bg-[#FF5A00] hover:bg-[#E04E00] text-white font-headline font-bold text-[10px] tracking-widest uppercase py-3 border border-[#FF5A00] transition-all flex items-center justify-center gap-2 rounded-none cursor-pointer">
